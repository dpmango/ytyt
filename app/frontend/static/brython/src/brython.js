...
elts.pop()
$path=$B.brython_path='../../brython/'}else{if(! $B.brython_path.endsWith("/")){$B.brython_path+="/"}
$path=$B.brython_path}
...
$B.file_cache={}
$B.$py_src={}
console.log($B.brython_path)
$B.path=['../../brython/'+'Lib','../../brython/'+'libs',$script_dir,'../../brython/'+'Lib/site-packages']
