...
export default {
  ...
  methods: {
    fragmentContent(content) {
      ...
      // const content3 =
      //   '<p>even_numbers = [i for i in range(1, 100) if not i % 2]</p>\n<h1 id="_1">Тест функционала</h1>\n<p>[brython-snippet]from random import choice\ndef print_greeting():\n    message = choice()\n    print(message)\nprint_greeting()\n[/brython-snippet]</p>\n<p><img alt="Дания" src="https://api.ytyt.ru/media/uploads/folder1/denmark.jpg"/><br/>\n<img alt="Дания2" src="https://api.ytyt.ru/media/uploads/folder2/inner_folder/denmark2.jpg"/></p>\n<pre><code class="language-python">print(\'Привет\')\n</code></pre>\n<pre><code class="language-python">even_numbers = [i for i in range(1, 100) if not i % 2]\n\nprint(even_numbers)\n</code></pre>\n<pre><code class="language-javascript">even_numbers = [i for i in range(1, 100) if not i % 2]\n\nprint(even_numbers)\n</code></pre>\n<p><code class="language-python">even_numbers = [i for i in range(1, 100) if not i % 2]</code></p>';
