    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_access_course_theme', models.ManyToManyField(blank=True, related_name='user_access_course_theme_set', related_query_name='user_access_course_theme', to='courses.CourseTheme', verbose_name='Доступные темы курса')),
                ('user_access_lesson_fragment', models.ManyToManyField(blank=True, related_name='user_access_lesson_fragment_set', related_query_name='user_access_lesson_fragment', to='courses.LessonFragment', verbose_name='Доступные фрагменты урока')),
